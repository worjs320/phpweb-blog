        ...
        <div class="container">
            ...
            <div class="jumbotron" style="padding-bottom:10px; max-width:800px; margin-right:auto; margin-left:auto;">
                <div style="padding : 30px;">
                    <form method="POST" action="./inputmovie_post.php">
                        ...
                        <div><img src = "./images/inputmovie.png" class="center-block" style="margin-top:30px; margin-bottom:20px;width: 100%; max-width:720px;"></div>
                        <div class="form-group">
                            <label>유튜브 코드</label>
                            <input type="text "name="address" class="form-control" rows="5" ></input>
                        </div>
